        ...
        wp_interactivity_state('chat', [
            ...
            'config' => [
                ...
                'messages' => [
                    ...
                    'opportunityPending'         => __('submitted a new opportunity for review:', 'starwishx'),
                    'opportunityPublished'       => __('Your opportunity has been published:', 'starwishx'),
                    'opportunityReturnedToDraft' => __('Your opportunity needs revisions:', 'starwishx'),
