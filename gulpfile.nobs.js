/**
 * Config gulpfile.nobs.js is almost same as gulpfile.js
 * except it's get rid off browser-sync from there
 * nobs = no browser-sync
 *
 * File: gulpfile.nobs.js
 */
