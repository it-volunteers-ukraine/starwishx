...
<div class="<?php echo $swiper_class; ?> newcard-content <?php echo $card_lg_class . ' ' . $class_card_version; ?> "
    ...
    <a href="<?php echo $permalink; ?>" class="link-def <?php echo $class_title; ?> newcard-title" title="<?php echo esc_attr($item_title); ?>">
        <?php echo esc_html($item_title); ?>
    </a>

    <?php if ($item_desc) : ?>
        <div class="text-r newcard-text" title="<?php echo esc_attr($item_desc); ?>">
